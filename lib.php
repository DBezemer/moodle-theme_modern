...
function theme_modern_bootstrap3_grid($hassidepost) {
		...
		if ($hassidepost) {
			...
			$regions = array('content' => 'col-sm-12 col-md-12');
			$regions['pre'] = 'row';
			$regions['post'] = 'col-sm-4 col-md-3';
		}
...
function theme_modern_initialise_reader(moodle_page $page) {
    $page->requires->yui_module('moodle-theme_modern-reader', 'M.theme_modern.initreader', array());
}

function theme_modern_process_css($css, $theme) {

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_modern_set_logo($css, $logo);

    // Set the background image for the header.
    $setting = 'headerbg';
    $headerbg = $theme->setting_file_url($setting, $setting);
    $css = theme_modern_set_headerbg($css, $headerbg, $setting);

    // Set the background image for the Page.
    $setting = 'bodybg';
    $bodybg = $theme->setting_file_url($setting, $setting);
    $css = theme_modern_set_bodybg($css, $bodybg, $setting);
    ...
    $css = theme_modern_set_customcss($css, $customcss);
    ...
    $css = theme_modern_set_themecolor($css, $themecolor);
    ...
    $css = theme_modern_set_bodycolor($css, $bodycolor);
    ...
    $css = theme_modern_set_fontcolor($css, $fontcolor);
    ...
    $css = theme_modern_set_headingcolor($css, $headingcolor);
    ...
    $css = theme_modern_set_defaultcategoryicon($css, $defaultcategoryicon);
    ...
    foreach (range(1, 20) as $categorynumber) {
        ...
        $css = theme_modern_set_categoryicon($css, $categoryicon, $categorynumber);
    }
    ...
    $css = theme_modern_set_videowidth($css, $videowidth);
    ...
    foreach (range(1, 12) as $quicklinksnumber) {
        ...
        $css = theme_modern_set_quicklinkiconcolor($css, $quicklinkiconcolor, $quicklinksnumber);
    }
    ...
    foreach (range(1, 12) as $quicklinksnumber) {
        ...
        $css = theme_modern_set_quicklinkbuttoncolor($css, $quicklinkbuttoncolor, $quicklinksnumber);
    }
    ...
    $css = theme_modern_set_bannercolor1($css, $bannercolor1);
    ...
    $css = theme_modern_set_bannercolor2($css, $bannercolor2);
    ...
    $css = theme_modern_set_bannercolor3($css, $bannercolor3);
    ...
    $css = theme_modern_set_bannercolor4($css, $bannercolor4);
    ...
    $css = theme_modern_set_bannercolor5($css, $bannercolor5);
    ...
    $css = theme_modern_set_bannercolor6($css, $bannercolor6);
    ...
    $css = theme_modern_set_bannercolor7($css, $bannercolor7);
    ...
    $css = theme_modern_set_bannercolor8($css, $bannercolor8);
    ...
    $css = theme_modern_set_bannercolor9($css, $bannercolor9);
    ...
    $css = theme_modern_set_bannercolor10($css, $bannercolor10);
    ...
    $css = theme_modern_set_transparency($css, $transparency);
 ...
 */
function theme_modern_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
...
function theme_modern_set_themecolor($css, $themecolor) {
...
function theme_modern_set_bodycolor($css, $bodycolor) {
...
function theme_modern_set_fontcolor($css, $fontcolor) {
...
function theme_modern_set_headingcolor($css, $headingcolor) {
...
function theme_modern_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        $theme = theme_config::load('modern');
        if ($filearea === 'logo') {
 ...
 */
function theme_modern_set_customcss($css, $customcss) {
 ...
 */
function theme_modern_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
...
/**
 * All theme functions should start with theme_modern_
 * @deprecated since 2.5.1
 */
function modern_process_css() {
 ...
 * @deprecated since 2.5.1
 */
function modern_set_customcss() {
    throw new coding_exception('Please call theme_'.__FUNCTION__.' instead of '.__FUNCTION__);
}

function theme_modern_set_headerbg($css, $headerbg, $setting) {
    global $OUTPUT;
...
function theme_modern_set_bodybg($css, $bodybg, $setting) {
    global $OUTPUT;
    $tag = '[[setting:bodybg]]';
    $replacement = $bodybg;
    if (is_null($replacement)) {
...
function theme_modern_set_defaultcategoryicon($css, $defaultcategoryicon) {
...
function theme_modern_set_categoryicon($css, $categoryicon, $categorynumber) {
...
function theme_modern_set_quicklinkiconcolor($css, $quicklinkiconcolor, $quicklinksnumber) {
...
function theme_modern_set_quicklinkbuttoncolor($css, $quicklinkbuttoncolor, $quicklinksnumber) {
...
function theme_modern_set_bannercolor1($css, $bannercolor1) {
...
function theme_modern_set_bannercolor2($css, $bannercolor2) {
...
function theme_modern_set_bannercolor3($css, $bannercolor3) {
...
function theme_modern_set_bannercolor4($css, $bannercolor4) {
...
function theme_modern_set_bannercolor5($css, $bannercolor5) {
...
function theme_modern_set_bannercolor6($css, $bannercolor6) {
...
function theme_modern_set_bannercolor7($css, $bannercolor7) {
...
function theme_modern_set_bannercolor8($css, $bannercolor8) {
...
function theme_modern_set_bannercolor9($css, $bannercolor9) {
...
function theme_modern_set_bannercolor10($css, $bannercolor10) {
...
function theme_modern_set_transparency($css, $transparency) {
...
function theme_modern_set_videowidth($css, $videowidth) {
...
function theme_modern_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('bootstrap', 'theme_modern');
    $page->requires->jquery_plugin('jquery.cookie', 'theme_modern');
    $page->requires->jquery_plugin('fitvids', 'theme_modern');
    $page->requires->jquery_plugin('nprogress', 'theme_modern');
    $page->requires->jquery_plugin('eventswipe', 'theme_modern');
	$page->requires->jquery_plugin('unslider', 'theme_modern');
	$page->requires->jquery_plugin('backstretch', 'theme_modern');
	$page->requires->jquery_plugin('modernizr', 'theme_modern');
}
