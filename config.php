...
if ('ltr' === get_string('thisdirection', 'langconfig')) {
    $THEME->sheets = array('moodle', 'font-awesome', $categorysheet , $tilessheet, $loginsheet, 'sidebar', ' nprogress', 'modern');
} else {
    $THEME->sheets = array('moodle-rtl', 'tinymce-rtl', 'yui2-rtl', 'forms-rtl', 'font-awesome', $categorysheet , $tilessheet, $loginsheet, ' nprogress', 'modern');
}
...
$THEME->layouts = array(
    ...
    'frontpage' => array(
        'file' => 'frontpage.php',
        'regions' => array('side-post','side-middle','side-pre'),
        'defaultregion' => 'side-post',
...
$THEME->csspostprocess = 'theme_modern_process_css';
