...
<div class="well">
<h2>Modern Theme</h2>
<p><img class=img-polaroid src="modern/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>Modern is a 2 column, clean and highly customisable theme built on the Bootstrap 3 framework.</p>
</div></div>';

$string['pluginname'] = 'Modern';
$string['configtitle'] = 'Modern';
...
$string['frontpagecontentdesc'] = 'This location appears as a highlight under the slideshow on the front page';
...
$string['tilesdesc'] = 'Displays resources and activities as tiles in a course';
...
$string['bannersettings'] = 'Slide show Settings';
$string['bannersettingssub'] = 'These settings control the slide show that appears on the Moodle front page';
...
$string['loginsettingsdesc'] = 'The custom version has a background slide show you can customise images for as well as a cleaner look.';

$string['enablecustomlogin'] = 'Use Custom Login';
$string['enablecustomlogindesc'] = 'When enabled this will use the theme augmented version of the login screen. Removing the tick will revert to the Moodle default version.<br>The augmented version allows you to upload background slides to really add pizazz to your page design.';
...
$string['facebookdesc'] = 'Enter the URL of your FaceBook page. (i.e https://www.facebook.com/uplearningwageningen)';

$string['twitter'] = 'Twitter URL';
$string['twitterdesc'] = 'Enter the URL of your Twitter feed. (i.e. https://www.twitter.com/uplearning)';

$string['googleplus'] = 'Google+ URL';
$string['googleplusdesc'] = 'Enter the URL of your Google+ profile. (i.e https://plus.google.com/+google)';

$string['linkedin'] = 'LinkedIn URL';
$string['linkedindesc'] = 'Enter the URL of your LinkedIn profile. (i.e https://www.linkedin.com/company/up-learning)';

$string['youtube'] = 'YouTube URL';
$string['youtubedesc'] = 'Enter the URL of your YouTube channel. (i.e https://www.youtube.com/moodlehq/videos)';

$string['tumblr'] = 'Tumblr URL';
$string['tumblrdesc'] = 'Enter the URL of your Tumblr. (i.e http://moodle.tumblr.com)';

$string['vimeo'] = 'Vimeo URL';
$string['vimeodesc'] = 'Enter the URL of your Vimeo channel. (i.e http://vimeo.com/moodlehq)';
...
$string['blogdesc'] = 'Enter the URL of your institution blog. (i.e http://www.uplearning.nl/actueel/blogs/)';
...
$string['enablecategoryicondesc'] = 'If ticked this will enable the category icon functionality.';
