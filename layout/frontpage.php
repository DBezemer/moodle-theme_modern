...
$container = 'container';
if ((isset($PAGE->theme->settings->fluidwidth) && 
...
$regions = theme_modern_bootstrap3_grid($hassidepost);
...
<nav role="navigation" class="navbar-fixed-top <?php echo $navbartype; ?>">
    ...
    <div class="navbar-header">
		...
		<button type="button" class="navbar-toggle" style="display:block;float:left;" id="menu-toggle">
...
<div id="page" class="<?php echo $container; ?>">
	...
	<div id="sidebar-wrapper" class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
